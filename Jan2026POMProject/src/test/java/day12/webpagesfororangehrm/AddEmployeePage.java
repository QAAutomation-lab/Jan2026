...
public class AddEmployeePage extends SeleniumUtility {
	...
	public WebElement getEpmloyeeIdInputField() {
		return epmloyeeIdInputField;
	}


	public WebElement getSaveButtonOnAddEmployeePage() {
		return saveButtonOnAddEmployeePage;
	}
