...
public class StaticGlobalVariableExample1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("default value of age is: "+age);//0
		System.out.println("default value of res is: "+res);//false
		System.out.println("default value of grade is: "+grade);// 
		System.out.println("default value of roi is: "+roi);//0.0
...
- if we declare any global variable but not initialized and trying use it dn it will give you default value based on data type
	...
	float & double default value will be 0.0
	char default value will be 'single character space'
	boolean default value will be false
*/
